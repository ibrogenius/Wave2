...
print(num_keys, '\n')
contains_breath = verse_dict.get('breathe', 'It does not exist')
print(contains_breath, '\n')
sorted_keys = sorted(verse_dict)
print(sorted_keys, '\n')
print(sorted_keys[0])
max_num = max(verse_dict.keys())
print(max_num, '\n')
first_key_in_verse_dict = list(verse_dict.keys())[0]
print(first_key_in_verse_dict)